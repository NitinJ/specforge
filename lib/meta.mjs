...
// Spec types: a design doc, a research report, design + an implementation plan,
// or an implementation-only plan. Drives which shell create scaffolds from and
// which sections the create-spec skill authors. Specs without a type (all
// pre-existing ones) are treated as 'design-impl' — the shape they were authored in.
export const SPEC_TYPES = ['design', 'research', 'design-impl', 'impl'];
