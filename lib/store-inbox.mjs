...
// picked_up remains readable for records created by older adapters. New workers
// inspect without mutation and set working when the review-spec skill begins.
