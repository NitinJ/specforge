...
/** A live publication of this spec. Absent means it is not published. Cleared
 *  on daemon start: the listener and the tunnel it names died with the previous
 *  daemon, and a quick tunnel would not come back on the same URL anyway. */
