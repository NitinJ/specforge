...
const NO_SESSION = 'No agent session is listening. Start Claude Code, Codex, or Pi in the SpecForge '
  + 'directory and arm its review delivery (specforge review-wait), then try again.';
