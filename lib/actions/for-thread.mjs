...
/**
 * The human half of a thread, scoped to what is being asked now.
 *
...
export function actionsForThread(thread, { specId, cli, batchIds } = {}) {
  ...
  return parseActions(humanBody(thread, batchIds)).map((a) => {
