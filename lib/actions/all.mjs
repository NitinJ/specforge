...
export const ALL_ACTIONS = [
  ...
  defineAction({
    ...
    kind: 'in-place',
    scope: 'aside',
    instruction: 'Merge this aside into the section above it and delete the aside. The originating '
      + "action's instruction decides the form, so a Visualize aside imports as a figure and an "
      + 'Explain simply aside as a callout. Place it where it belongs in the section rather than '
      + 'appending it, and keep comment threads on the imported blocks: they anchor to blocks, not '
      + 'to the aside.',
  }),
