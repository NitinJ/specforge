...
export function assetResolver(baseDir) {
  ...
  return (src) => {
    ...
    // Containment check. The path comes from the markdown, so `../../.ssh/id_rsa`
    // or an absolute path would otherwise read an unrelated file and embed it in
    // a spec that then gets served, and published. Import reads what sits beside
