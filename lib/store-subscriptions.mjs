...
/**
 * Run `fn` under an exclusive lock, the same O_EXCL lockfile discipline
 * comments.json uses (lib/store-comments.mjs): two CLI processes joining or
 * leaving at once must not lose each other's write. Best-effort past the wait
 * budget, and a stale lock from a dead holder is reclaimed.
 */
