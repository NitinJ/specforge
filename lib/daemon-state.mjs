...
//
// This mirrors v1's lib/server-state.mjs but is rooted at storeRoot() (the global
// store) and adds the singleton lock + a pid-liveness check that ensureServer()
// uses to decide whether an advertised daemon can be trusted.
