...
//   3. Ids are validated before use. `assertSpecId` is the path-traversal guard
//      for every filesystem read, and a `parent` value read off disk is input
//      like any other.
//
...
function parentOf(meta) {
  return meta && meta.parent ? meta.parent : null;
}
