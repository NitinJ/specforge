 ...
 */
// The canonical chip table. server/public/review.js mirrors it client-side (a
// browser script loads no modules), so it stays exported even though the home
// page rows stopped wearing chips.
