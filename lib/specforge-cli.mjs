...
/**
 * Block until any spec attached to this session has pending work, then return
 * its kind, items, and continuation guidance. The host runs this in its supported
 * delivery mode; its completion surfaces the work to the owning session.
 *
