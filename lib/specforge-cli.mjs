...
import { attach, detach, specsForSession, heartbeat, HEARTBEAT_MS } from './attach.mjs';
 ...
 */
export async function cmdWaitBatch({ timeout = 1200, interval = HEARTBEAT_MS / 1000 } = {}, deps = {}) {
  const session = sessionId(deps);
