 ...
 */
export async function cmdAside({ id, section, action, file, body } = {}) {
  ...
  const out = writeAside(readSpecHtml(id), { section, action, body: content });
  writeSpecHtml(id, out.html);
  return { id, asideId: out.id, section, action };
}
...
export const COMMANDS = Object.assign(Object.create(null), {
  ...
  aside: (p, f) => cmdAside({
    id: p[0], section: f.section, action: f.action, file: f.file, body: f.body,
  }),
