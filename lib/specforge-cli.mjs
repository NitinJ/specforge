...
export async function cmdCreate({ title, origin = null, type = DEFAULT_TYPE } = {}, deps = {}) {
  ...
  const html = stampHtml(templateHtmlFor(type), { force: true });
...
export const BOOLEAN_FLAGS = new Set(['clear', 'rotate', 'write', 'force', 'install-service', 'zip', 'all']);
 ...
 */
async function cmdComponents({ sub, id, all, force }) {
