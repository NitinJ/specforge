 ...
 * — the attached session, the export, the share record — drives owner controls
 * this socket does not serve, and hands a stranger the author's session and
 * Google Doc for nothing.
 */
