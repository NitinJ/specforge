...
// (lib palettes live in review.css, keyed on [data-theme="<id>"]).
const THEMES = [
  'light', 'dark',
...
// on-demand Google Fonts loading live in review.js/review.css).
const FONTS = [
  'default',
  'inter', 'source-sans', 'work-sans',
  'source-serif', 'merriweather', 'lora',
