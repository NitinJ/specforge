...
const LANGUAGE_RULES = [
  ...
  },
  {
    ...
    // The trailing (?!-) keeps hyphenated compounds out: "the best-effort
    // fallback" and "the worst-case latency" are terms of art, not claims about
    // a ranking, and both are common enough in specs to make the rule noise.
