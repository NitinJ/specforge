...
Generated by `components build` from `components/` (library v2). Do not edit.
...
```html
<ol class="sf-stages"><li data-sf-stage="1"><div class="sh"><h3>Stage 1: Name</h3></div><ol class="sf-tasks"><li data-sf-task="1.1" data-sf-status="todo">Task<ul><li class="verify">verify: how</li></ul></li></ol></li></ol>
```
